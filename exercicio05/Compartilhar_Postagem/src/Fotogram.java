class Fotogram implements PlataformaSocial {
    ...
    public void compartilharImagem(Postagem postagem) {
        System.out.println("Você compartilhou essa imagem no Fotogram: " + postagem.getTitulo());
    }

    @Override
    public void compartilharVideo(Postagem postagem) {
        System.out.println("Você compartilhou esse vídeo no Fotogram: " + postagem.getTitulo());
    }
}
